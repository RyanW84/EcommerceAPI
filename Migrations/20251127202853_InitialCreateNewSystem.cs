...
{
    /// <inheritdoc />
    public partial class InitialCreateNewSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorySales", x => new { x.CategoryId, x.SaleId });
                    table.ForeignKey(
                        name: "FK_CategorySales_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategorySales_Sales_SaleId",
                        column: x => x.SaleId,
